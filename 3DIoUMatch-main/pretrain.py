...
if FLAGS.dataset == 'matterport':
    from matterport.matterport_detection_dataset import MatterportDetectionDataset, MAX_NUM_OBJ
    from matterport.model_util_matterport import MatterportDatasetConfig_md40

    DATASET_CONFIG = MatterportDatasetConfig_md40()
    TRAIN_DATASET = MatterportDetectionDataset('train', num_points=NUM_POINT,
                                            augment=True,
                                            use_color=FLAGS.use_color, use_height=(not FLAGS.no_height),
                                            labeled_sample_list=FLAGS.labeled_sample_list)
    TEST_DATASET = MatterportDetectionDataset('val', num_points=NUM_POINT,
                                           augment=False,
