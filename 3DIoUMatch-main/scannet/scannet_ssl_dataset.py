...
from scannet.model_util_scannet import ScannetDatasetConfig_md40, rotate_aligned_boxes
...
class ScannetSSLLabeledDataset(Dataset):
    ...
    def __init__(self, labeled_sample_list=None, num_points=20000, use_color=False, use_height=False, augment=False):
        ...
        self.data_path = os.path.join(BASE_DIR, 'scannet_train_detection_data_md40')
