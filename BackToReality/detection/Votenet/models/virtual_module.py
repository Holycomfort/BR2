...
class virtual_generator(nn.Module):
    ...
    def generate_one_batch(self, flip_YZ, flip_XZ, rot_angle, s_idx, device, Is_floor, Is_wall, Is_vis):
    ...
    def forward(self, data_augmentation, scan_idx, device=None, Is_floor=True, Is_wall=False, Is_vis=False):
        ...
        for i in range(batch_size):
            ...
            s_idx = scan_idx[i]
            ret = self.generate_one_batch(flip_YZ, flip_XZ, rot_angle, s_idx, device, Is_floor, Is_wall, Is_vis)
