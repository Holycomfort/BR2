...
class GridConv(nn.Module):
    def __init__(self, num_class, num_heading_bin, num_size_cluster, mean_size_arr, num_proposal, sampling,
                 seed_feat_dim=288, query_feats='seed', iou_class_depend=True):
        super().__init__()
    ...
    def forward(self, center, size, heading, end_points, prefix):
        ...
        end_points[f'{prefix}iou_scores'] = net_iou.transpose(2, 1)[:, :, -self.iou_size:]
        return end_points
